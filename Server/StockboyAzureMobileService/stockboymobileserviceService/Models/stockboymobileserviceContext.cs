...
namespace stockboymobileserviceService.Models
{
    public class stockboymobileserviceContext : DbContext
    {
        ...
        public stockboymobileserviceContext() : base(connectionStringName)
        {
        } 
