...
namespace StockboyNoSQLServiceService.Models
{
    public class StockboyNoSQLServiceContext : DbContext
    {
        ...
        public StockboyNoSQLServiceContext() : base(connectionStringName)
        {
        } 
