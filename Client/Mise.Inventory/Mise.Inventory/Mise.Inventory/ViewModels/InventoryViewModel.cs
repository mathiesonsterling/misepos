...
namespace Mise.Inventory.ViewModels
{
	public class InventoryViewModel : BaseSearchableViewModel<InventoryViewModel.InventoryLineItemDisplayLine>
	{
        ...
        public override async Task OnAppearing()
        {
            try
            {
                ...
                if(!told){
                    ...
                    await _inventoryService.MarkCurrentInventoryShownClearReminderAsShown();
                }
            }
            catch (Exception e)
            {
		...
		public ICommand DeleteLineItemCommand{
			get{return new Command<InventoryLineItemDisplayLine> (DeleteLineItemT, CanDeleteLI);}
		}
		...
		public async Task MoveLineItemToPosition(int oldPos, int newPos){
			try{
				...
				var newInventoryPositionVal = newPos;
				...
				await _inventoryService.MoveLineItemToPosition (item.Source, newInventoryPositionVal);	
			} catch(Exception e){
				HandleException (e);
			}
		}
