...
{
    /// <summary>
    /// A Check for people at a bar, that don't have sections or table seating.  Most basic Check in the system
    /// </summary>
    public class Check : EntityBase, ICheck
    {
        public Check()
        {
        ...
        public ICloneableEntity Clone()
        {
            ...
            {
                newTab.AddOrderItem(oi.Clone());
            }

            foreach (var pay in GetPayments())
            {
                newTab.AddPayment(pay.Clone());
            }
            return newTab;
        }
        ...
        /// <summary>
        /// ID of the server that is started this tab
        /// </summary>
        public Guid CreatedByServerID { get; set; }

        /// <summary>
        /// Last employee that touched this tab
        /// </summary>
        ...
        public void When(ICheckEvent checkEvent)
        {
            ...
            Revision = checkEvent.EventOrderingID.OrderingID;
